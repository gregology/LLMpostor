...
class Config:
    ...
    def PROMPTS_FILE(self):
        return get_config().prompts_file
    
    @property
    def MAX_PLAYERS_PER_ROOM(self):
        return get_config().max_players_per_room
    
    @property
    def RESPONSE_TIME_LIMIT(self):
        return get_config().response_time_limit
    
    @property
    def GUESSING_TIME_LIMIT(self):
        return get_config().guessing_time_limit
    
    @property
    def RESULTS_DISPLAY_TIME(self):
        return get_config().results_display_time
...
class DevelopmentConfig(Config):
    ...
    @property
    def FLASK_ENV(self):
        return get_config().flask_env


class ProductionConfig(Config):
    """Production configuration for backward compatibility"""
...
# Configuration mapping for backward compatibility
config = {
